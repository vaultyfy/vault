        ...
        >
          <Box width="100%">
            ...
            <Text
              ...
              color="#2A2A2A"
            >
              We conduct thorough due diligence to verify your details and
              tailor the best loan options for you. Plus, if you have a strong
              thrift history on Vaultyfy, you may qualify for lower interest
              charges
            </Text>
          </Box>
          <Button
            ...
            onClick = {() => {navigate({to: "/dashboard/loan-application"})}}
          >
            get started
          </Button>
        </VStack>
