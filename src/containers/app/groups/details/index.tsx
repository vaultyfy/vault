    ...
    <Box width="100%" minH="100dvh">
      {loading ? (
        <Skeleton
          ...
          width={{ lg: "200px", md: "180px", base: "70%" }}
        />
      ) : (
        <HStack gap="0">
          <IconButton
              ...
              <OrderedList spacing="18px">
                ...
                <ListItem>
                  ...
                  >
                    ...
                    will be applied to their next contribution, and their payout
                    will be delayed by the same number of days, weeks, or months
                    missedFailure to meet four payment deadlines will lead to
                    the forfeiture of all previously contributed funds and a
